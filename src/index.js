...
const routing = (
  <Router>
    <Switch>
      ...
      <RotaPrivadaLogado path="/detalhes-da-instituicao/:idInstituicao" component={DetalhesDaInstituicao} /> {/*http://localhost:5000/instituicao/adicionar-turma, http://localhost:5000/instituicao/alterar-instituicao, http://localhost:5000/instituicao/deletar-instituicao, http://localhost:5000/turma/alterar-turma*/}
